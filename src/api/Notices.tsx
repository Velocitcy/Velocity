...
export const types = findByPropsLazy("GENERIC", "BLOCKED_BY_PROXY", "STREAMER_MODE", "MACOS_19_DEPRECATED_MESSAGE", "DOWNLOAD_NAG");
...
export function showNotice(notice: Notice) {
    ...
    noticesQueue.push([notice.type ?? types.GENERIC, message, notice.buttonText, notice.onClick]);
